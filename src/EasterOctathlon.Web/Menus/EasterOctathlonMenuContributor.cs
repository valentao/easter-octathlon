...
namespace EasterOctathlon.Web.Menus;

public class EasterOctathlonMenuContributor : IMenuContributor
{
    ...
    {
        var l = context.GetLocalizer<EasterOctathlonResource>();

        //Home
        context.Menu.AddItem(
            new ApplicationMenuItem(
                EasterOctathlonMenus.Home,
                l["Menu:Home"],
                "~/",
                icon: "fa fa-home",
                order: 1
