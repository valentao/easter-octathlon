...
public class EasterOctathlonDatabaseCheck : IHealthCheck, ITransientDependency
{
    protected readonly IIdentityRoleRepository IdentityRoleRepository;

    public EasterOctathlonDatabaseCheck(IIdentityRoleRepository identityRoleRepository)
    {
