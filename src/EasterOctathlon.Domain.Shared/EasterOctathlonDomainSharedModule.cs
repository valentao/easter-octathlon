...
public class EasterOctathlonDomainSharedModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        EasterOctathlonGlobalFeatureConfigurator.Configure();
        EasterOctathlonModuleExtensionConfigurator.Configure();
    }
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            options.FileSets.AddEmbedded<EasterOctathlonDomainSharedModule>();
        });

        Configure<AbpLocalizationOptions>(options =>
        {
            options.Resources
                .Add<EasterOctathlonResource>("en")
                .AddBaseTypes(typeof(AbpValidationResource))
                .AddVirtualJson("/Localization/EasterOctathlon");

            options.DefaultResourceType = typeof(EasterOctathlonResource);
        ...
        {
            options.MapCodeNamespace("EasterOctathlon", typeof(EasterOctathlonResource));
        });
    }
}
